...
training_set = train_datagen.flow_from_directory(r'D:\Final Year project\Project\processed_images\train',
                                                 target_size=(sz, sz),
                                                 batch_size=10,
                                                 color_mode='grayscale',
                                                 class_mode='categorical')

test_set = test_datagen.flow_from_directory(r'D:\Final Year project\Project\processed_images\test',
                                            target_size=(sz , sz),
                                            batch_size=10,
                                            color_mode='grayscale',
                                            class_mode='categorical') 
